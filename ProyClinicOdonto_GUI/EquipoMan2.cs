    ...
    public partial class EquipoMan2 : Form
    {
        ...
        private void btnGrabar_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (cboPiso.Text.Trim() == String.Empty)
                {
                    throw new Exception("Escoge un piso por favor:");
                }
                ...
                {
                    MessageBox.Show("Equipo insertado exitosamente, puedes buscarlo por su nombre");
                    this.Close();
                }
                else
                {
