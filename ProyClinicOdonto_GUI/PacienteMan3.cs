    ...
    public partial class PacienteMan3 : Form
    {
        ...
        private void btnGrabar_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Se actualizaron los datos del paciente exitosamente!!");
                    this.Close();
                }
                else
                {
        ...
        private void PacienteMan3_Load_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                lblDni.Text = Codigo;
                lblNombre.Text = objPacienteBE.Nombres;
                lblApellido.Text = objPacienteBE.Apellidos;
                lblGenero.Text = objPacienteBE.Genero;
